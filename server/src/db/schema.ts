...
//   consume   — one unit consumed; amountCents = unit price at that moment (null if unpriced)
//   undo    — reverses one specific consumption entry; amountCents copied from it
...
export const entries = sqliteTable(
  "entry",
  {
    ...
    actorId: text("actor_id")
      .notNull()
      .references(() => user.id),
    kind: text("kind", { enum: ["consume", "undo", "payment", "charge"] }).notNull(),
