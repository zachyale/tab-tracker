...
Self-hosted tab tracking for friend groups. Bought a keg? Tape the QR code to it,
friends tap **+** every time they pour, and everyone can see what they owe.

- **Accounts** are ledgers ("Home") with a custom URL (`/accounts/sample-home`),
  a currency, and a set of **options** (e.g. "Guinness pint — $3.00").
...
- Append-only ledger: prices are locked at the moment of each pour, so
  repricing the keg never rewrites history.
